...
import os
import time
from map_importer import readLevelsFromFileToArray
from map_importer import printTheMap
    ...
    if dlaKogo:
        ...
        if gameStateDict['P1Points']>7: # jak zdobedzie wiekszosc kluczy 
            ...
            if gameStateDict['P1Score']>2: # jak wygra 3 rundy 
                ...
                print('***PLAYER1 WINS***')
                printTheMap(lista)  # wczytywanie mapy
...
lista = list()
readLevelsFromFileToArray(lista, BOARD_FILE_NAME)
